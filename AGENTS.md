...
- News uses PostgreSQL, Cloudflare R2, TR/EN localized fields without fallback, immutable-after-publish localized slugs, drafts/versions, and generated migrations. Preview and production must use separate database/R2 bucket resources and credentials.
